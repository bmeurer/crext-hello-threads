...
var wasmBinaryFile = 'hello-threads.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=5504;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('hello-threads.worker.js');
